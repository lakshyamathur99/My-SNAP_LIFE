...
//@input vec4 helmetCapColor = {1, 1, 1, 1} {"widget":"color"}
//@input vec4 helmetCushionsColor = {1, 1, 1, 1} {"widget":"color"}
//@ui {"widget":"group_end"}
...
function init()
{
	...
	if(script.properties.api.cricketCapMaterial)
	{
		script.helmetCapColor.a = 1;
		script.properties.api.cricketCapMaterial.mainPass.baseColor = script.helmetCapColor;
	}

	if(script.properties.api.cricketCushionsMaterial)
	{
		script.helmetCushionsColor.a = 1;
		script.properties.api.cricketCushionsMaterial.mainPass.baseColor = script.helmetCushionsColor;
		script.properties.api.cricketGridMaterial.mainPass.baseColor = script.helmetCushionsColor;
	}
